...
class Regist extends CI_Controller
{
        ...
        public function index()
    {
        ...
        $this->form_validation->set_rules('asal_instansi', 'asal_instansi', 'required|trim', [
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                ...
                'asal_instansi' => $asal_instansi = htmlspecialchars($this->input->post('asal_instansi', true)),
