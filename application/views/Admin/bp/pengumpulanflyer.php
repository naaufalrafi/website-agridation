        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Data Pengumpulan Flayer</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Pendaftar Business Plan Yang Sudah ataupun Belum Mengumpulkan Flayer</h4>
                                        <p class="card-title-desc">Data Pengumpulan Flyer Business Plan
                                            <br>1. Klik "Lolos" untuk memilih peserta yang lolos ke tahap Presentasi
                                            <br>2. Klik "Tidak" untuk memilih peserta yang tidak lolos ke tahap Presentasi
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($p->flyer == NULL): ?>
                                                        Belum mengumpulkan
                                                    <?php else:?>
                                                        <a href="<?= base_url('assets/media/upload/')?><?= $p->flyer ?>" target="_blank" rel="noopener noreferrer"><img src="<?= base_url('assets/media/upload/')?><?= $p->flyer ?>" alt="Bukti Pembayaran <?= $p->nama_ketua ?>" width="100"></a>
                                                    <?php endif ?>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('Admin/Bp/gagal/') . $p->id_glomba ?>"><button class="btn btn-danger" onclick="return confirm('Yakin untuk tidak meloloskan?')">Tidak</button></a>
                                                    <a href="<?= base_url('Admin/Bp/finalis/') . $p->id_glomba ?>"><button class="btn btn-primary" onclick="return confirm('Yakin untuk meloloskan?')">Lolos</button></a>
                                                </td>
                                                <td>
