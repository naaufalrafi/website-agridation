        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Data Pendaftar Business Plan Yang Belum Diverifikasi</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Pendaftar Business Plan Yang Belum Diverifikasi</h4>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('Admin/Bp/tidakverif/') . $p->id_glomba ?>"><button class="btn btn-danger" onclick="return confirm('Yakin untuk tidak memverifikasi?')">Tidak</button></a>
                                                    <a href="<?= base_url('Admin/Bp/verif/') . $p->id_glomba ?>"><button class="btn btn-primary" onclick="return confirm('Yakin untuk memverifikasi?')">Verifikasi</button></a>
                                                </td>
