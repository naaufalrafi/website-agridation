        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Data Pendaftar Creative Video</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Pendaftar Creative Video</h4>
                                        <p class="card-title-desc">Berisikan semua data pendaftar creative video dari segala jenis status
