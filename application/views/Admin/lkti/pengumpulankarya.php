        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Data Pengumpulan Karya LKTI</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Pendaftar LKTI Yang Sudah ataupun Belum Mengumpulkan Karya</h4>
                                        <p class="card-title-desc">Data Pengumpulan Karya LKTI
                                            <br>1. Klik "Lolos" untuk memilih peserta yang lolos menjadi FINALIS
                                            <br>2. Klik "Tidak" untuk memilih peserta yang tidak lolos menjadi FINALIS
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('Admin/Lkti/gagal/') . $p->id_glomba ?>"><button class="btn btn-danger" onclick="return confirm('Yakin untuk tidak meloloskan?')">Tidak</button></a>
                                                    <a href="<?= base_url('Admin/Lkti/finalis/') . $p->id_glomba ?>"><button class="btn btn-primary" onclick="return confirm('Yakin untuk meloloskan?')">Lolos</button></a>
                                                </td>
                                                <td>
