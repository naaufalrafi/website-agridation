            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Data Pendaftar Desain Poster Yang Belum Diverifikasi</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('Admin/Poster/tidakverif/') . $p->id_glomba ?>"><button class="btn btn-danger" onclick="return confirm('Yakin untuk tidak memverifikasi?')">Tidak</button></a>
                                                    <a href="<?= base_url('Admin/Poster/verif/') . $p->id_glomba ?>"><button class="btn btn-primary" onclick="return confirm('Yakin untuk memverifikasi?')">Verifikasi</button></a>
                                                </td>
