        ...
        <div class="container-fluid">
            ...
            <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Pendaftar Desain Poster yang Sudah Diverifikasi dan Data Pengumpulan Karya</h4>
                                        <p class="card-title-desc">Data Pengumpulan Karya Desain Poster
