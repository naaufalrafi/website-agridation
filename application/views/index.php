...
<main>
    ...
    <div class="container" style="height: 100%;">
      <div class="row d-flex align-items-center" style="height: 100%;">
        ...
        <div class="col col-lg-5 col-xl-4 d-none d-lg-block  ">
          <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel" style="width: 410px;">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <div class="card cardInfo d-block" style="width: 305px; height: 300px; margin-left: 52px;">
                  <img src="<?= base_url('assets/Illustration/') ?>fotografi.svg" class="card-img-top" style="display: block; margin: auto; width: 128px;" alt="...">
                  <div class="card-body">
              ...
              <div class="carousel-item">
                <div class="card cardInfo d-block" style="width: 305px; height: 300px; margin-left: 52px;">
                  <img src="<?= base_url('assets/Illustration/') ?>podcast.svg" class="card-img-top" style="display: block; margin: auto; width: 128px;" alt="...">
                  <div class="card-body">
              ...
              <div class="carousel-item">
                <div class="card cardInfo d-block" style="width: 305px; height: 300px; margin-left: 52px;">
                  <img src="<?= base_url('assets/Illustration/') ?>BP.svg" class="card-img-top" style="display: block; margin: auto; width: 128px;" alt="...">
                  <div class="card-body">
              ...
              <div class="carousel-item">
                <div class="card cardInfo d-block" style="width: 305px; height: 300px; margin-left: 52px;">
                  <img src="<?= base_url('assets/Illustration/') ?>cv.svg" class="card-img-top" style="display: block; margin: auto; width: 128px;" alt="...">
                  <div class="card-body">
              ...
              <div class="carousel-item">
                <div class="card cardInfo d-block" style="width: 305px; height: 300px; margin-left: 52px;">
                  <img src="<?= base_url('assets/Illustration/') ?>Poster.svg" class="card-img-top" style="display: block; margin: auto; width: 128px;" alt="...">
                  <div class="card-body">
              ...
              <div class="carousel-item">
                <div class="card cardInfo d-block" style="width: 305px; height: 300px; margin-left: 52px;">
                  <img src="<?= base_url('assets/Illustration/') ?>ltki.svg" class="card-img-top" style="display: block; margin: auto; width: 128px;" alt="...">
                  <div class="card-body">
      ...
      <div class="row row-cols-1 mt-3">
        <div class="col col-lg-4">
          <div class="card cardArtikel" style="max-width: 300px; max-height: 400px;">
            <img src="<?= base_url('assets/img/artikel/aslfkasjl.png') ?>" class="card-img-top img-fluid" style=" width: 280px; display: block; margin: auto; padding-top: 10px;">
            <div class="card-body">
        ...
        <div class="col col-lg-4 d-none d-lg-block">
          <div class="card cardArtikel" style="max-width: 300px; max-height: 400px;">
            <img src="<?= base_url('assets/img/artikel/23517.jpg') ?>" class="card-img-top img-fluid" style="width: 280px; display: block; margin: auto; padding-top: 10px;">
            <div class="card-body">
        ...
        <div class="col col-lg-4 d-none d-lg-block">
          <div class="card cardArtikel" style="max-width: 300px; max-height: 400px;">
            <img src="<?= base_url('assets/img/home/artikel/') ?>3.svg" class="card-img-top img-fluid" style="width: 280px; display: block; margin: auto; padding-top: 10px;">
            <div class="card-body">
  ...
  <!-- Section Partner -->
  <section id="partner" class="pt-3 pb-3" style="background-color: #fffcd9;">
    <div class="container">
      <h2 class="text-center">Partner</h2>
      <div class="row d-flex align-items-center justify-content-center">
        <div class="col-3">
          <img src="<?= base_url('assets/img/home/') ?>Wardah.png" class="img-fluid" alt="">
        </div>
        <div class="col-3">
          <img src="<?= base_url('assets/img/home/') ?>sariRoti.png" class="img-fluid" alt="">
        </div>
        <div class=" col-3">
          <img src="<?= base_url('assets/img/home/') ?>okeprint.png" class="img-fluid rounded" alt="">
        </div>
        <!-- <div class=" col-3">
