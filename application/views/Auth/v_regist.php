                ...
                <div class="overflow-auto col-12 col-lg-6 kanan">
                    ...
                    <form action="<?php echo base_url('Auth/Regist'); ?>" method="POST">
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" id="asal_instansi" name="asal_instansi" value="<?= set_value('asal_instansi'); ?>" placeholder="Masukan Asal Instansi Anda (Exp. IPB University)">
                            <?= form_error('asal_instansi', '<small class="text-white">', '</small>') ?>
                        </div>
                        <div class="row">
                            <div class="col">
