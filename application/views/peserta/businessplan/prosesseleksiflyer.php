<div class="isi-konten">
                ...
                <div class="container d-flex justify-content-center align-items-center flex-column mt-4">
                    <img src="<?= base_url('assets/Illustration/')?>pengumpulan-lkti-berhasil.svg" class="img-fluid"
                    ...
                    <div class="text text-center mt-3">
                        ...
                        <p style="opacity: 0.7; font-size: 14px; max-width: 400px;">Terimakasih Telah Menjadi bagian
                            dari Agen Perubahan
                            Flyermu sedang dalam proses seleksi untuk menuju grand final
                            Catat tanggalnya 5 September 2022</p>
                    </div>
                </div>
            </div>