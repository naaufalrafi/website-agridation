    <div class="isi-konten">
        <div class="top-content">
            ...
            <div class="d-flex align-items-center mt-4">
                ...
                <div class="text-top ms-3">
                    ...
                    <p><span>Ikuti keseruan dalam mengikuti mini event untuk mengembangkan kemampuanmu di bidang pertanian dan
                            menangkan hadiah menariknya.</span> </p>
                    <small>Jangan Lupa Paket KIT-nya untuk mengikuti Mini
                        Event!!</small><br>
                    <a href="https://ipb.link/shopee-minievent-agridation2022" class="btn btn-cart ms-0" target="_blank" rel="noopener noreferrer">Beli Paket Kit
                        <img src="<?= base_url('assets/icon/') ?>cart.svg" alt="">
                    </a>
                    <small><span class="text-light">COD di Sekolah Vokasi, dengan menghubungi a.n Neila / +62 815-1683-876</span></small>
        ...
        <div class="row mt-4 align-items-center">
            ...
            <div class="col-7">
                <input type="text" name="nama_lengkap" id="namaKetua" value="<?= set_value('nama_lengkap'); ?>" placeholder="Masukkan nama lengkap">
        ...
        <a href="#" class="">
            <button type="submit" class="tombol mt-4 d-flex align-items-center justify-content-center" style="color: white;">
