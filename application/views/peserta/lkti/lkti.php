    ...
    <div class="isi-konten">
                ...
                <?= form_open_multipart('Lomba/Lkti/daftarlomba') ?>
                ...
                <div class="row mt-4 align-items-center">
                    ...
                    <div class="col-7">
                        <input type="text" name="nama_anggota2" id="namaAnggota2" value="<?= set_value('nama_anggota2'); ?>" placeholder="Masukkan nama lengkap anggota 2 (Optional)">
                    </div>
                </div>
                <div class="row mt-4 align-items-center">
                    <div class="col-5">
