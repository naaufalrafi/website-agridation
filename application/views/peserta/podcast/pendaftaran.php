    <div class="isi-konten">
                ...
                <?= form_open_multipart('Lomba/Podcast/daftarlomba') ?>
                <div class="row mt-4 align-items-center">
                    <div class="col-5">
                        <h5>Nama Lengkap</h5>
                    </div>
                    <div class="col-7">
                        <input type="text" name="nama_ketua" value="<?= set_value('nama_ketua'); ?>"
                            placeholder="Masukkan nama lengkap Anggota 1 / Ketua">
                ...
                <div class="row mt-4 align-items-center">
                    ...
                    <div class="col-7">
                        <input type="text" name="anggota1" value="<?= set_value('anggota1'); ?>"
                            placeholder="Masukkan nama lengkap Anggota 2 (Opsional)">
                    </div>
                </div>
                <div class="row mt-4 align-items-center">
                    <div class="col-5">
                    ...
                    <div class="col-7">
                        <input class="form-control" name="bukti_identitas" type="file" id="formfile" value="<?= set_value('bukti_identitas'); ?>">
